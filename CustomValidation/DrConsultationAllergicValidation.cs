...
{
    public class DrConsultationAllergicValidation : ValidationAttribute, IClientModelValidator
    {
        ...
        {
            var model = (DrConsultationAllergicViewModel)validationContext.ObjectInstance;
