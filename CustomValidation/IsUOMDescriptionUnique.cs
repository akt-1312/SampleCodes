...
{
    public class IsUOMDescriptionUnique : ValidationAttribute, IClientModelValidator
    {
        public void AddValidation(ClientModelValidationContext context)
        {
            context.Attributes.Add("data-val", "true");
            context.Attributes.Add("data-val-isuniqueuom", "Unit Of Measurement Description {0} already exist in current table");
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (model.UnitOfMeasurementId == 0)
            {
                ...
                == description.StringCompareFormat()
                || x.Code.Replace(" ", string.Empty).ToLower().Trim()
