...
{
    [Area("Doctor")]
    public class DrConsultationPackageOrderController : Controller
    {
        private readonly ApplicationDbContext db;

        public DrConsultationPackageOrderController(ApplicationDbContext db)
        {
            this.db = db;
        }
        [HttpGet]
        public async Task<IActionResult> DrConsultationPackageOrder(int appointmentId)
        {
