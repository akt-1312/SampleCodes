...
{
    [Area("Doctor")]
    public class DrConsultationInvestigationOrderController : Controller
    {
        private readonly ApplicationDbContext db;

        public DrConsultationInvestigationOrderController(ApplicationDbContext db)
        {
            this.db = db;
        }
        [HttpGet]
        public async Task<IActionResult> DrConsultationInvestigationOrder(int appointmentId)
        {
